...
class LeftMenu(CTkCanvas):
    ...
    def __init__(self, master: Tk, windows: dict[str, CTkCanvas | CTkFrame], *args: any, **kwargs: any) -> None:
...
class TopMenu(CTkCanvas):
    def __init__(self, *args: any, **kwargs: any) -> None:
        ...
        wow = ImageTk.PhotoImage(Image.open("images/wow_icon.ico").resize((50, 50)))

        self.can = CTkCanvas(self, width=50, height=50, bg=Theme.background1, bd=0, highlightthickness=0)
